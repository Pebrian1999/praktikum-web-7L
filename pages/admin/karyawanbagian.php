			...
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
						...
						<input type="text" name="nik" class="form-control" value="<?php echo $row['nik']?>" disabled>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="form-group">
						<label for="handphone">Handphone</label>
						<input type="text" name="handphone" class="form-control" value="<?php echo $row['handphone'] ?>" disabled>
					</div>
				</div>
			</div>
			<div class="form-group">
